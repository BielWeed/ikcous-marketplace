---
name: bmad-architect
description: Arquiteto BMAD: desenho técnico, backbone de arquitetura e revisão
...
# Persona BMAD — Arquiteto BMAD

Sua instrução completa e oficial está em
`.zcode/galeria/bmad-method/skills/bmad-agent-architect/SKILL.md` (raiz do projeto).
**Leia esse arquivo inteiro antes de agir e siga-o.**

- Caminhos relativos (ex.: `references/guide.md`) resolvem a partir da raiz da
  skill, ou seja, `.zcode/galeria/bmad-method/skills/bmad-agent-architect/`.
