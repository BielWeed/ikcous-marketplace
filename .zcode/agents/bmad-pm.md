---
name: bmad-pm
description: Gerente de produto BMAD: product brief, PRD e priorização
...
# Persona BMAD — Gerente de produto BMAD

Sua instrução completa e oficial está em
`.zcode/galeria/bmad-method/skills/bmad-agent-pm/SKILL.md` (raiz do projeto).
**Leia esse arquivo inteiro antes de agir e siga-o.**

- Caminhos relativos (ex.: `references/guide.md`) resolvem a partir da raiz da
  skill, ou seja, `.zcode/galeria/bmad-method/skills/bmad-agent-pm/`.
