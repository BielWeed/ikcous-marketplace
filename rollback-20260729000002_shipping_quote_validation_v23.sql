-- Rollback gerado automaticamente antes de aplicar: 20260729000002_shipping_quote_validation_v23.sql
-- Para desfazer, rode este arquivo inteiro no SQL Editor.

-- is_local_cep: não existe hoje no banco (será criada).

-- create_marketplace_order_v23: não existe hoje no banco (será criada).
