-- ROLLBACK MANUAL — 20261165000000_a_loja_nasce_com_frete_gratis_desligado
--
-- Devolve os DOIS pontos que a migration tocou: o DEFAULT da coluna volta
-- a 100 e a upsert_store_config volta ao corpo vivo da 20261121000000 (o
-- mesmo que o preflight da migration exigiu — hash
-- 2403a21fa4f3ee2c905df77b368868017bc512b0ec579452c6b8558513ecce31).
-- Linhas de DADO não são tocadas em nenhum dos dois sentidos: loja que
-- nasceu com 0 continua com 0 (a decisão sobre lojas existentes é do dono).
ALTER TABLE public.store_config
  ALTER COLUMN free_shipping_min SET DEFAULT 100;

-- Corpo vivo anterior (20261121000000), restaurado por inteiro:
