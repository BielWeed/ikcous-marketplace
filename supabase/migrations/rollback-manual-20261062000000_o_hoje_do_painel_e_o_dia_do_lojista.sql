-- Rollback manual de 20261062000000_o_hoje_do_painel_e_o_dia_do_lojista.sql
--
-- Restaura get_admin_analytics_v2 com o corpo VIVO antes da onda 4 do
-- laudo 0109 (a cópia literal do bloco da 20261021000000, caracteres de
-- 20261021000000). Para desfazer, rode este arquivo inteiro no SQL Editor
-- do banco afetado.
