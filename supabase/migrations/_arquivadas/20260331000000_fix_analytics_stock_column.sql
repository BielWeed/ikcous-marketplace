-- 20260331_fix_analytics_stock_column.sql
-- Goal: Fix "column stock does not exist" by using "estoque" in get_admin_analytics_v2
...
BEGIN
    ...
    -- 2. Auxiliary Counts (Fix: 'estoque' instead of 'stock')
    ...
    -- 3. Top Products (Fix: nome, preco, quantidade)
