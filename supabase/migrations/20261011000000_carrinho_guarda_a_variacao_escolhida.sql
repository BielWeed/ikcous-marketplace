...
BEGIN
    ...
    INSERT INTO public.cart_items (user_id, product_id, variant_id, quantity, updated_at, variant_names)
    SELECT 
        v_user_id,
        ...
        -- 26/08/2026 (CARRINHO-05): a coluna existia, o cliente ja mandava o
        -- campo, e este INSERT o descartava em silencio.
