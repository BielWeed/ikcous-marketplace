...
CREATE INDEX IF NOT EXISTS idx_marketplace_order_history_created_by ON public.marketplace_order_history (
    created_by
);
CREATE INDEX IF NOT EXISTS idx_marketplace_order_history_order_id ON public.marketplace_order_history (
    order_id
);
CREATE INDEX IF NOT EXISTS idx_marketplace_order_items_variant_id ON public.marketplace_order_items (
    variant_id
);
CREATE INDEX IF NOT EXISTS idx_marketplace_orders_address_id ON public.marketplace_orders (
    address_id
);
CREATE INDEX IF NOT EXISTS idx_marketplace_orders_coupon_id ON public.marketplace_orders (
    coupon_id
);
CREATE INDEX IF NOT EXISTS idx_user_addresses_user_id ON public.user_addresses (
    user_id
);
...
USING (
    EXISTS (
        ...
        WHERE
            public.marketplace_orders.id
            = public.marketplace_order_items.order_id
