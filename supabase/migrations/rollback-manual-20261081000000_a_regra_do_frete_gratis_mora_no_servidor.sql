-- ROLLBACK MANUAL de 20261081000000_a_regra_do_frete_gratis_mora_no_servidor.
--
-- Restaura o estado EXATO anterior das v23/v24: os corpos verbatim da
-- 20261040000000 (última migration que as reescreveu), incluindo os DROPs
-- das sobrecargas de 12 argumentos que ela mantém derrubadas. Reabre
-- CONSCIENTEMENTE a regra antiga de frete grátis (item marcado
