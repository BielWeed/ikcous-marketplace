...
-- conferido por grep) e de create_marketplace_order_v23/v24 (corpo da
-- 20261025000000 CARACTERE A CARACTERE, com SÓ o bloco da recusa ampliado:
-- o SELECT do diagnóstico ganha o `id` e o ramo-limite ganha a subconsulta
-- de vaga presa). O bloco de CÁLCULO de desconto é INVOLUTO — guarda-chuva
-- da peça: nenhuma regra de cálculo muda aqui, e o teste
...
-- 20261025000000_cupom_diz_por_que_e_recusado.sql (CREATE OR REPLACE
-- idempotente, traz o corpo anterior inteiro de volta);
...
-- ============================================================
-- create_marketplace_order_v23 — corpo da 20261025000000 caractere a
-- caractere, com SÓ o bloco da recusa ampliado (o SELECT do diagnóstico
-- ganha o `id`; o ramo-limite ganha a subconsulta de vaga presa e a frase
-- canônica).
-- ============================================================
...
-- ============================================================
-- create_marketplace_order_v24 — corpo da 20261025000000 caractere a
