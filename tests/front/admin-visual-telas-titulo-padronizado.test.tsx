//
// Onda 3 da reforma visual do painel (03/09): as 6 telas que faltavam
// (Avaliações, Perguntas, Banners, Carrosséis, Cupons e o formulário de
// cupom) passam a usar o AdminPageHeader — a fórmula do título do painel
// vive em UM lugar, como já acontece nas ondas anteriores (o componente é
// testado em tests/front/admin-page-header.test.tsx).
//
// Por que lê FONTE e não renderiza a tela: as 6 views são pesadas (hooks,
...
// sobrando. Antes desta onda as 6 telas tinham 5 fórmulas de título
...
describe("as 6 telas que faltavam usam o título padrão do painel", () => {
  it("o glob casou as 6 telas de verdade (nada de prova vazia)", () => {
