...
export const TransportadorasSection = memo(
  function TransportadorasSection({ onDirtyMudou }: TransportadorasSectionProps) {
        ...
        <div className="admin-glass border-y border-white/5 p-3.5 shadow-2xl sm:rounded-2xl sm:border-x sm:p-4">
          <div className="flex flex-col gap-3">
            <p className="text-left text-[9.5px] leading-snug text-zinc-400">
              Escolha como o frete é calculado fora da sua cidade: pela taxa
              fixa que você define na tela de Frete, ou cotado na hora por uma
              transportadora. Quem compra vê o resultado no fechamento do
              pedido.
            </p>
              ...
              <div className="space-y-3 rounded-xl border border-white/10 bg-zinc-950/60 p-3.5">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-[11px] font-semibold leading-snug text-red-300">
                        ...
                        <span className="mt-0.5 block font-normal text-red-300/70">
                          ...
                          leitura funcionar — assim nada é gravado por cima do
                          que já está salvo.
                        </span>
                      </p>
                    </div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    disabled={!credsLoaded}
                    value={
                      shippingCreds[escolha.provider]?.token || ""
                    }
                    onChange={(e) => {
