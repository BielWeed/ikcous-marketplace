...
async function finalTestSingular() {
    try {
        await client.connect();

        console.log('--- Inserindo Pedido de Teste Final (Tabela marketplace_order) ---');
        ...
        await client.query(`
            INSERT INTO marketplace_order_item (order_id, product_id, quantity, price)
